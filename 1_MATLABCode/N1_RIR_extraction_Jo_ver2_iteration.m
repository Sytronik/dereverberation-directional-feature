...
ph_ax = [0:5:355]/180*pi;
for xx = 1:length(ph_ax)
    
    s{xx} = [5.56+2*cos(ph_ax(xx)) 3.63+2*sin(ph_ax(xx)) 1.41];                    % Source location(s) (x,y,z) in m
    ...
    tic
    [h1, H1] = smir_generator(c, Fs, sphLocation, s{xx}, L, beta,...
